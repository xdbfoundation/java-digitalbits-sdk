...
public class OffersRequestBuilderTest {
  private static final String offerResponse = "{\n" +
          "\"_links\": {\n" +
          "\"self\": {\n" +
          "\"href\": \"https://frontier.livenet.digitalbits.io/offers/12345\"\n" +
          "},\n" +
          "\"offer_maker\": {\n" +
          "\"href\": \"https://frontier.livenet.digitalbits.io/accounts/GDCY6FXA2FZU4OZWQEES5DAQFQPYODNT53KVDBHVAZLZTSSMSITZDJ7Q\"\n" +
          "}\n" +
          "},\n" +
          "\"id\": 12345,\n" +
          "\"paging_token\": \"12345\",\n" +
  ...
  public void testForAccount() {
    ...
    HttpUrl uri = server.offers()
            ...
            .buildUri();
    assertEquals("https://frontier.testnet.digitalbits.io/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/offers?limit=200&order=desc", uri.toString());
  }
  ...
  public void testWithoutParams() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/offers", uri.toString());
  }
  ...
  public void testForSeller() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/offers?seller=GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H", uri.toString());
  }
  ...
  public void testForSponsor() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/offers?sponsor=GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H", uri.toString());
  }
  ...
  public void testForSellingCreditAlphanum4Asset() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/offers?selling=USD%3AGDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG", uri.toString());
  }
  ...
  public void testForBuyingCreditAlphanum4Asset() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/offers?buying=XCN%3AGCNY5OXYSY4FKHOPT2SPOQZAOEIGXB5LBYW3HVU3OWSTQITS65M5RCNY", uri.toString());
  }

  @Test
  public void testForSellingCreditAlphanum12Asset() {
    Server server = new Server("https://frontier.testnet.digitalbits.io");
    Asset selling = new AssetTypeCreditAlphaNum12("DIGITALBITS", "GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG");
    HttpUrl uri = server.offers().forSellingAsset(selling).buildUri();
    assertEquals("https://frontier.testnet.digitalbits.io/offers?selling=DIGITALBITS%3AGDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG", uri.toString());
  }

  @Test
  public void testForBuyingCreditAlphanum12Asset() {
    Server server = new Server("https://frontier.testnet.digitalbits.io");
    Asset buying = new AssetTypeCreditAlphaNum12("DIGITALBITS", "GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG");
    HttpUrl uri = server.offers().forBuyingAsset(buying).buildUri();
    assertEquals("https://frontier.testnet.digitalbits.io/offers?buying=DIGITALBITS%3AGDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG", uri.toString());
  }
  ...
  public void testForSellingNativeAsset() {
    ...
    HttpUrl uri = server.offers().forSellingAsset(selling).buildUri();
    assertEquals("https://frontier.testnet.digitalbits.io/offers?selling=native", uri.toString());
  }
  ...
  public void testForBuyingNativeAsset() {
    ...
    HttpUrl uri = server.offers().forBuyingAsset(buying).buildUri();
    assertEquals("https://frontier.testnet.digitalbits.io/offers?buying=native", uri.toString());
  }
  ...
  public void testForSellingAssetAndBuyingAsset() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/offers?selling=USD%3AGDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG&buying=XCN%3AGCNY5OXYSY4FKHOPT2SPOQZAOEIGXB5LBYW3HVU3OWSTQITS65M5RCNY", uri.toString());
  }
