...
public class OperationDeserializerTest extends TestCase {
  ...
  public void testDeserializeSetOptionsOperationWithNonEd25519Key() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"self\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/operations/44921793093312513\"\n" +
            "          },\n" +
            "          \"transaction\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/transactions/d991075183f7740e1aa43700b824f2f404082632f1db9d8a54db00574f83393b\"\n" +
            "          },\n" +
            "          \"effects\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/operations/44921793093312513/effects\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/effects?order=desc\\u0026cursor=44921793093312513\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/effects?order=asc\\u0026cursor=44921793093312513\"\n" +
            "          }\n" +
            "        },\n" +
  ...
  public void testDeserializePathPaymentOperation() {
    String json = "{\n" +
            "  \"_links\": {\n" +
            "    \"self\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/operations/75252830662840321\"\n" +
            "    },\n" +
            "    \"transaction\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/transactions/fb2f5655c70a459220ac09eb3d6870422b58dcf5c5ffb5e5b21817b4d248826e\"\n" +
            "    },\n" +
            "    \"effects\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/operations/75252830662840321/effects\"\n" +
            "    },\n" +
            "    \"succeeds\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/effects?order=desc\\u0026cursor=75252830662840321\"\n" +
            "    },\n" +
            "    \"precedes\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/effects?order=asc\\u0026cursor=75252830662840321\"\n" +
            "    }\n" +
            "  },\n" +
  ...
  public void testDeserializeManageDataOperation() {
    String json = "{\n" +
            "  \"_links\": {\n" +
            "    \"self\": {\n" +
            "      \"href\": \"https://frontier.testnet.digitalbits.io/operations/14336188517191688\"\n" +
            "    },\n" +
            "    \"transaction\": {\n" +
            "      \"href\": \"https://frontier.testnet.digitalbits.io/transactions/ad99999615f653528e67d8c8783e14044519c3e5233b73633aa88050c5856103\"\n" +
            "    },\n" +
            "    \"effects\": {\n" +
            "      \"href\": \"https://frontier.testnet.digitalbits.io/operations/14336188517191688/effects\"\n" +
            "    },\n" +
            "    \"succeeds\": {\n" +
            "      \"href\": \"https://frontier.testnet.digitalbits.io/effects?order=desc\\u0026cursor=14336188517191688\"\n" +
            "    },\n" +
            "    \"precedes\": {\n" +
            "      \"href\": \"https://frontier.testnet.digitalbits.io/effects?order=asc\\u0026cursor=14336188517191688\"\n" +
            "    }\n" +
            "  },\n" +
