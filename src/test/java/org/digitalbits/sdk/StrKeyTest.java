...
public class StrKeyTest {
  ...
  public void testValidSignedPayloadEncode() {
    ...
    SignedPayloadSigner signedPayloadSigner = new SignedPayloadSigner(StrKey.decodeDigitalBitsAccountId("GA7QYNF7SOWQ3GLR2BGMZEHXAVIRZA4KVWLTJJFC7MGXUA74P7UJVSGZ"), payload);
    ...
    signedPayloadSigner = new SignedPayloadSigner(StrKey.decodeDigitalBitsAccountId("GA7QYNF7SOWQ3GLR2BGMZEHXAVIRZA4KVWLTJJFC7MGXUA74P7UJVSGZ"), payload);
  ...
  public void testEncodeToXdrRoundTrip() {
    ...
    assertEquals(address, StrKey.encodeDigitalBitsAccountId(account));
    ...
    assertEquals(address, StrKey.encodeDigitalBitsAccountId(StrKey.muxedAccountToAccountId(muxedAccount)));
  }
  ...
  public void testEncodeToXDRMuxedAccountMAddress() {
    ...
    assertEquals(muxedAddress, StrKey.encodeDigitalBitsMuxedAccount(muxedAccount));
