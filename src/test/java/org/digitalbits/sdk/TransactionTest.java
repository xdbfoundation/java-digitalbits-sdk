...
public class TransactionTest {
    ...
    public void testParseV0Transaction() throws FormatException, IOException {
        ...
        Transaction transaction = new Transaction(
                ...
                new io.digitalbits.sdk.Operation[]{new CreateAccountOperation.Builder(destination.getAccountId(), "2000").build()},
                null,
        ...
        io.digitalbits.sdk.xdr.TransactionEnvelope decodedTransaction = io.digitalbits.sdk.xdr.TransactionEnvelope.decode(is);
    ...
    public void testSha256HashSigning() throws FormatException {
        ...
        Transaction transaction = new Transaction(
                ...
                Transaction.MIN_BASE_FEE,
                account.getIncrementedSequenceNumber(),
                new io.digitalbits.sdk.Operation[]{new PaymentOperation.Builder(destination.getAccountId(), new AssetTypeNative(), "2000").build()},
                null,
                new TransactionPreconditions(null, null, 0, 0, new ArrayList<SignerKey>(),null),
                Network.PUBLIC
        );
