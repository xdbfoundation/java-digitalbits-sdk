...
public class TransactionPreconditionsTest {
    ...
    public void itRoundTripsFromV2ToV1IfOnlyTimeboundsPresent() throws IOException {
        ...
        preconditionsBuilder.discriminant(PreconditionType.PRECOND_V2);
        PreconditionsV2.Builder v2Builder = new PreconditionsV2.Builder();
        io.digitalbits.sdk.xdr.TimeBounds xdrTimeBounds = new io.digitalbits.sdk.xdr.TimeBounds.Builder().minTime(new TimePoint(new Uint64(1L))).maxTime(new TimePoint(new Uint64(2L))).build();
    ...
    public void itConvertsToV2Xdr() throws IOException {
        ...
        SignerKey signerKey = new SignerKey.Builder()
                ...
                .ed25519SignedPayload(new SignerKey.SignerKeyEd25519SignedPayload.Builder()
                        .payload(payload)
                        .ed25519(new Uint256(StrKey.decodeDigitalBitsAccountId("GDW6AUTBXTOC7FIKUO5BOO3OGLK4SF7ZPOBLMQHMZDI45J2Z6VXRB5NR")))
                        .build())
                .build();
