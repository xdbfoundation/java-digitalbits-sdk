...
import io.digitalbits.sdk.responses.ClaimableBalanceResponse;
...
public class ClaimableBalancesRequestBuilderTest {
  ...
  public void testForSponsor() {
    ...
    HttpUrl uri = server.claimableBalances()
        ...
        .buildUri();
    assertEquals("https://frontier.testnet.digitalbits.io/claimable_balances?sponsor=GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H&limit=200&order=desc", uri.toString());
  }
  ...
  public void testWithoutParams() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/claimable_balances", uri.toString());
  }
  ...
  public void testForClaimant() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/claimable_balances?claimant=GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H", uri.toString());
  }
  ...
  public void testForNativeAsset() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/claimable_balances?asset=native", uri.toString());
  }
  ...
  public void testForAsset() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/claimable_balances?asset=USD%3AGBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H", uri.toString());
  }
  ...
  public void testForAssetAndClaimant() {
    ...
    assertEquals("https://frontier.testnet.digitalbits.io/claimable_balances?claimant=GCNY5OXYSY4FKHOPT2SPOQZAOEIGXB5LBYW3HVU3OWSTQITS65M5RCNY&asset=USD%3AGBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H", uri.toString());
  }
