...
public class AssetsPageDeserializerTest extends TestCase {
    ...
    public void testDeserialize() {
        ...
        assertEquals(page.getLinks().getSelf().getHref(), "https://frontier.livenet.digitalbits.io/assets?order=asc&limit=10&cursor=");
        assertEquals(page.getLinks().getNext().getHref(), "https://frontier.livenet.digitalbits.io/assets?order=asc&limit=10&cursor=AsrtoDollar_GDJWXY5XUASXNL4ABCONR6T5MOXJ2S4HD6WDNAJDSDKQ4VS3TVUQJEDJ_credit_alphanum12");
    ...
    String json = "{\n" +
            "  \"_links\": {\n" +
            "    \"self\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/assets?order=asc\\u0026limit=10\\u0026cursor=\"\n" +
            "    },\n" +
            "    \"next\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/assets?order=asc\\u0026limit=10\\u0026cursor=AsrtoDollar_GDJWXY5XUASXNL4ABCONR6T5MOXJ2S4HD6WDNAJDSDKQ4VS3TVUQJEDJ_credit_alphanum12\"\n" +
            "    },\n" +
            "    \"prev\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/assets?order=desc\\u0026limit=10\\u0026cursor=6497847_GCGNWKCJ3KHRLPM3TM6N7D3W5YKDJFL6A2YCXFXNMRTZ4Q66MEMZ6FI2_credit_alphanum12\"\n" +
            "    }\n" +
            "  },\n" +
            "  \"_embedded\": {\n" +
            "    \"records\": [\n" +
            ...
            "        \"paging_token\": \"9FRONTIERS_GB2HXY7UEDCSHOWZ4553QFGFILNU73OFS2P4HU5IB3UUU66TWPBPVTGW_credit_alphanum12\",\n" +
            "        \"accounts\": {\n" +
            "          \"authorized\": 3,\n" +
            "          \"authorized_to_maintain_liabilities\": 0,\n" +
            "          \"unauthorized\": 0\n" +
