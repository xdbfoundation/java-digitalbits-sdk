...
public class TradesPageDeserializerTest extends TestCase {
    ...
    public void testDeserialize() {
        ...
        assertEquals(tradesPage.getLinks().getNext().getHref(), "https://frontier.livenet.digitalbits.io/trades?cursor=3748308153536513-0&limit=10&order=asc");
        assertEquals(tradesPage.getLinks().getPrev().getHref(), "https://frontier.livenet.digitalbits.io/trades?cursor=3697472920621057-0&limit=10&order=desc");
        assertEquals(tradesPage.getLinks().getSelf().getHref(), "https://frontier.livenet.digitalbits.io/trades?cursor=&limit=10&order=asc");
    ...
    String json = "{\n" +
            "  \"_links\": {\n" +
            "    \"self\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/trades?cursor=\\u0026limit=10\\u0026order=asc\"\n" +
            "    },\n" +
            "    \"next\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/trades?cursor=3748308153536513-0\\u0026limit=10\\u0026order=asc\"\n" +
            "    },\n" +
            "    \"prev\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/trades?cursor=3697472920621057-0\\u0026limit=10\\u0026order=desc\"\n" +
            "    }\n" +
            "  },\n" +
            "  \"_embedded\": {\n" +
            "    \"records\": [\n" +
            ...
            "          },\n" +
            "          \"base\": {\n" +
            "            \"href\": \"https://frontier.livenet.digitalbits.io/accounts/GAVH5JM5OKXGMQDS7YPRJ4MQCPXJUGH26LYQPQJ4SOMOJ4SXY472ZM7G\"\n" +
            "          },\n" +
            "          \"counter\": {\n" +
            "            \"href\": \"https://frontier.livenet.digitalbits.io/accounts/GBB4JST32UWKOLGYYSCEYBHBCOFL2TGBHDVOMZP462ET4ZRD4ULA7S2L\"\n" +
            "          },\n" +
            "          \"operation\": {\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://frontier.livenet.digitalbits.io/operations/3712329212497921\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://frontier.livenet.digitalbits.io/operations/3716237632737281\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://frontier.livenet.digitalbits.io/operations/3716302057246721\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://frontier.livenet.digitalbits.io/operations/3725961438695425\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://frontier.livenet.digitalbits.io/operations/3748080520269825\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://frontier.livenet.digitalbits.io/operations/3748308153536513\"\n" +
            "          }\n" +
            "        },\n" +
    ...
    String jsonLiquidityPool = 
            ...
            "  \"_links\": {\n" + 
            "    \"self\": {\n" + 
            "      \"href\": \"https://frontier.livenet.digitalbits.io/liquidity_pools/a468d41d8e9b8f3c7209651608b74b7db7ac9952dcae0cdf24871d1d9c7b0088/trades?cursor=&limit=10&order=asc\"\n" + 
            "    },\n" + 
            "    \"next\": {\n" + 
            "      \"href\": \"https://frontier.livenet.digitalbits.io/liquidity_pools/a468d41d8e9b8f3c7209651608b74b7db7ac9952dcae0cdf24871d1d9c7b0088/trades?cursor=163706513893126145-0&limit=10&order=asc\"\n" + 
            "    },\n" + 
            "    \"prev\": {\n" + 
            "      \"href\": \"https://frontier.livenet.digitalbits.io/liquidity_pools/a468d41d8e9b8f3c7209651608b74b7db7ac9952dcae0cdf24871d1d9c7b0088/trades?cursor=163706170297630721-3&limit=10&order=desc\"\n" + 
            "    }\n" + 
            "  },\n" + 
            "  \"_embedded\": {\n" + 
            "    \"records\": [\n" + 
            ...
            "          },\n" + 
            "          \"base\": {\n" + 
            "            \"href\": \"https://frontier.livenet.digitalbits.io/liquidity_pools/a468d41d8e9b8f3c7209651608b74b7db7ac9952dcae0cdf24871d1d9c7b0088\"\n" + 
            "          },\n" + 
            "          \"counter\": {\n" + 
            "            \"href\": \"https://frontier.livenet.digitalbits.io/accounts/GAVYIUWQFQX2GJ7FWNGVXSSLMJO75V5XY5M2YON4DKYD24LPB6QLCERP\"\n" + 
            "          },\n" + 
            "          \"operation\": {\n" + 
            "            \"href\": \"https://frontier.livenet.digitalbits.io/operations/163706170297630721\"\n" + 
            "          }\n" + 
            "        },\n" + 
            ...
            "          },\n" + 
            "          \"base\": {\n" + 
            "            \"href\": \"https://frontier.livenet.digitalbits.io/accounts/GA7BRV2K3OM27NLVY2IJQGYZEQ7AEZSPR3Y3XA6COHPMOPOEUHQBDYBC\"\n" + 
            "          },\n" + 
            "          \"counter\": {\n" + 
            "            \"href\": \"https://frontier.livenet.digitalbits.io/liquidity_pools/a468d41d8e9b8f3c7209651608b74b7db7ac9952dcae0cdf24871d1d9c7b0088\"\n" + 
            "          },\n" + 
            "          \"operation\": {\n" + 
            "            \"href\": \"https://frontier.livenet.digitalbits.io/operations/163706436584558593\"\n" + 
            "          }\n" + 
            "        },\n" + 
