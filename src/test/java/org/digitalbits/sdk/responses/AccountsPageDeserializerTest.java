...
public class AccountsPageDeserializerTest extends TestCase {
  ...
  String jsonLiquidityPool = "{\n" + 
          "  \"_links\": {\n" + 
          "    \"self\": {\n" + 
          "      \"href\": \"https://frontier.publicnode.org/accounts/?asset=USDC%3AGA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN&cursor=&limit=1&order=desc\"\n" + 
          "    },\n" + 
          "    \"next\": {\n" + 
          "      \"href\": \"https://frontier.publicnode.org/accounts/?asset=USDC%3AGA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN&cursor=GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST&limit=1&order=desc\"\n" + 
          "    },\n" + 
          "    \"prev\": {\n" + 
          "      \"href\": \"https://frontier.publicnode.org/accounts/?asset=USDC%3AGA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN&cursor=GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST&limit=1&order=asc\"\n" + 
          "    }\n" + 
          "  },\n" + 
          "  \"_embedded\": {\n" + 
          "    \"records\": [\n" + 
          ...
          "        \"_links\": {\n" + 
          "          \"self\": {\n" + 
          "            \"href\": \"https://frontier.publicnode.org/accounts/GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST\"\n" + 
          "          },\n" + 
          "          \"transactions\": {\n" + 
          "            \"href\": \"https://frontier.publicnode.org/accounts/GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST/transactions{?cursor,limit,order}\",\n" + 
          "            \"templated\": true\n" + 
          "          },\n" + 
          "          \"operations\": {\n" + 
          "            \"href\": \"https://frontier.publicnode.org/accounts/GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST/operations{?cursor,limit,order}\",\n" + 
          "            \"templated\": true\n" + 
          "          },\n" + 
          "          \"payments\": {\n" + 
          "            \"href\": \"https://frontier.publicnode.org/accounts/GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST/payments{?cursor,limit,order}\",\n" + 
          "            \"templated\": true\n" + 
          "          },\n" + 
          "          \"effects\": {\n" + 
          "            \"href\": \"https://frontier.publicnode.org/accounts/GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST/effects{?cursor,limit,order}\",\n" + 
          "            \"templated\": true\n" + 
          "          },\n" + 
          "          \"offers\": {\n" + 
          "            \"href\": \"https://frontier.publicnode.org/accounts/GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST/offers{?cursor,limit,order}\",\n" + 
          "            \"templated\": true\n" + 
          "          },\n" + 
          "          \"trades\": {\n" + 
          "            \"href\": \"https://frontier.publicnode.org/accounts/GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST/trades{?cursor,limit,order}\",\n" + 
          "            \"templated\": true\n" + 
          "          },\n" + 
          "          \"data\": {\n" + 
          "            \"href\": \"https://frontier.publicnode.org/accounts/GDZZYLIIJ24HWAVWAQ2PJVNKHUJLJVVLFY2SSLYINBHDY5KZTLPTEST/data/{key}\",\n" + 
          "            \"templated\": true\n" + 
          "          }\n" + 
          "        },\n" + 
