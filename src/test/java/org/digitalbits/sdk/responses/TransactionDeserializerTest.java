...
import io.digitalbits.sdk.MemoHash;
import io.digitalbits.sdk.MemoNone;
...
public class TransactionDeserializerTest extends TestCase {
  ...
  String muxed = "{\n" +
      ...
      String jsonNullMemoHash = "{\n" + 
              ...
              "  \"_links\": {\n" + 
              "    \"self\": {\n" + 
              "      \"href\": \"https://frontier.livenet.digitalbits.io/transactions/b8084d1cf9b44ac9b84b4064a6b0919ed9251b1ead000a89e7abd483d1165b17\"\n" + 
              "    },\n" + 
              "    \"account\": {\n" + 
              "      \"href\": \"https://frontier.livenet.digitalbits.io/accounts/GBM7VIKSHFBR5SRXM7YMIM7RGVAEOPWBQRLCHGRGTE4NGYVJQAXGZLTB\"\n" + 
              "    },\n" + 
              "    \"ledger\": {\n" + 
              "      \"href\": \"https://frontier.livenet.digitalbits.io/ledgers/38840744\"\n" + 
              "    },\n" + 
              "    \"operations\": {\n" + 
              "      \"href\": \"https://frontier.livenet.digitalbits.io/transactions/b8084d1cf9b44ac9b84b4064a6b0919ed9251b1ead000a89e7abd483d1165b17/operations{?cursor,limit,order}\",\n" + 
              "      \"templated\": true\n" + 
              "    },\n" + 
              "    \"effects\": {\n" + 
              "      \"href\": \"https://frontier.livenet.digitalbits.io/transactions/b8084d1cf9b44ac9b84b4064a6b0919ed9251b1ead000a89e7abd483d1165b17/effects{?cursor,limit,order}\",\n" + 
              "      \"templated\": true\n" + 
              "    },\n" + 
              "    \"precedes\": {\n" + 
              "      \"href\": \"https://frontier.livenet.digitalbits.io/transactions?order=asc\\u0026cursor=166819725233311744\"\n" + 
              "    },\n" + 
              "    \"succeeds\": {\n" + 
              "      \"href\": \"https://frontier.livenet.digitalbits.io/transactions?order=desc\\u0026cursor=166819725233311744\"\n" + 
              "    },\n" + 
              "    \"transaction\": {\n" + 
              "      \"href\": \"https://frontier.livenet.digitalbits.io/transactions/b8084d1cf9b44ac9b84b4064a6b0919ed9251b1ead000a89e7abd483d1165b17\"\n" + 
              "    }\n" + 
