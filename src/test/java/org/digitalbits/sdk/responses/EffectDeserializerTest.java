...
public class EffectDeserializerTest extends TestCase {
  ...
  public void testDeserializeAccountInflationDestinationUpdatedEffect() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/operations/40181321724596225\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/effects?order=desc&cursor=40181321724596225-1\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/effects?order=asc&cursor=40181321724596225-1\"\n" +
            "          }\n" +
            "        },\n" +
  ...
  public void testDeserializeDataCreatedEffect() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/operations/40181480638386177\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/effects?order=desc&cursor=40181480638386177-1\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"https://frontier.testnet.digitalbits.io/effects?order=asc&cursor=40181480638386177-1\"\n" +
            "          }\n" +
            "        },\n" +
