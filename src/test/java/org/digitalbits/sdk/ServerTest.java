...
import io.digitalbits.sdk.requests.ErrorResponse;
import io.digitalbits.sdk.responses.Page;
import io.digitalbits.sdk.responses.SubmitTransactionResponse;
import io.digitalbits.sdk.responses.SubmitTransactionTimeoutResponseException;
import io.digitalbits.sdk.responses.SubmitTransactionUnknownResponseException;
...
public class ServerTest {
    private final String publicRootResponse = "{\n" +
            ...
            "    },\n" +
            "    \"order_book\": {\n" +
            "      \"href\": \"https://frontier.livenet.digitalbits.io/order_book{?selling_asset_type,selling_asset_code,selling_asset_issuer,buying_asset_type,buying_asset_code,buying_asset_issuer,limit}\",\n" +
            "      \"templated\": true\n" +
            "    },\n" +
            "    \"self\": {\n" +
            ...
            "    }\n" +
            "  },\n" +
            "  \"frontier_version\": \"0.18.0-92259749c681df66a8347f846e94681a24f2a920\",\n" +
            "  \"core_version\": \"digitalbits-core 11.1.0 (324c1bd61b0e9bada63e0d696d799421b00a7950)\",\n" +
    ...
    private final String failureResponse =
            "{\n" +
            "  \"type\": \"https://developers.digitalbits.io/api/errors/http-status-codes/frontier-specific/transaction-failed/\",\n" +
            "  \"title\": \"Transaction Failed\",\n" +
            "  \"status\": 400,\n" +
            "  \"detail\": \"TODO\",\n" +
            "  \"instance\": \"frontier-testnet-001.prd.digitalbits001.internal.digitalbits-ops.com/IxhaI70Tqo-112305\",\n" +
            "  \"extras\": {\n" +
    ...
    private final String internalServerErrorResponse =
            "{\n" +
            "  \"type\":     \"https://developers.digitalbits.io/api/errors/http-status-codes/standard/\",\n" +
    ...
    public void testCheckMemoRequiredWithMemo() throws IOException, AccountRequiresMemoException {
        ...
        Transaction transaction = new TransactionBuilder(AccountConverter.enableMuxed(), account, Network.PUBLIC)
                ...
                .setTimeout(TransactionPreconditions.TIMEOUT_INFINITE)
                .addMemo(new MemoText("Hello, DigitalBits."))
                .setBaseFee(100)
                .build();
        transaction.sign(source);
    ...
    public void testCheckMemoRequiredNoDestinationOperation() throws IOException {
        ...
        Account account = new Account(source.getAccountId(), 1L);
        Transaction transaction = new TransactionBuilder(AccountConverter.enableMuxed(), account, Network.PUBLIC)
                .addOperation(new ManageDataOperation.Builder("Hello", "DigitalBits".getBytes()).build())
                .addOperation(new PaymentOperation.Builder(DESTINATION_ACCOUNT_MEMO_REQUIRED_A, new AssetTypeNative(), "10").build())
