...
public class LedgerHeader implements XdrElement {
  ...
  private DigitalBitsValue scpValue;
  public DigitalBitsValue getScpValue() {
    return this.scpValue;
  }
  public void setScpValue(DigitalBitsValue value) {
    this.scpValue = value;
  }
  ...
  public static void encode(XdrDataOutputStream stream, LedgerHeader encodedLedgerHeader) throws IOException{
    ...
    DigitalBitsValue.encode(stream, encodedLedgerHeader.scpValue);
  ...
  public static LedgerHeader decode(XdrDataInputStream stream) throws IOException {
    ...
    decodedLedgerHeader.scpValue = DigitalBitsValue.decode(stream);
  ...
  public static final class Builder {
    ...
    public Builder scpValue(DigitalBitsValue scpValue) {
