...
public class CreateClaimableBalanceOperation extends Operation {
  ...
  io.digitalbits.sdk.xdr.Operation.OperationBody toOperationBody(AccountConverter accountConverter) {
    ...
    io.digitalbits.sdk.xdr.Claimant[] xdrClaimants = new io.digitalbits.sdk.xdr.Claimant[claimants.size()];
    for (int i = 0; i < claimants.size(); i++) {

      io.digitalbits.sdk.xdr.Claimant.ClaimantV0 v0 = new io.digitalbits.sdk.xdr.Claimant.ClaimantV0();
      ...
      xdrClaimants[i] = new io.digitalbits.sdk.xdr.Claimant();
  ...
  public static class Builder {
    ...
    Builder(CreateClaimableBalanceOp op) {
      ...
      for(io.digitalbits.sdk.xdr.Claimant c : op.getClaimants()) {
        claimants.add(new Claimant(StrKey.encodeDigitalBitsAccountId(c.getV0().getDestination()), Predicate.fromXdr(c.getV0().getPredicate())));
      }
    }
