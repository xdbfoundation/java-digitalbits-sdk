...
import io.digitalbits.sdk.requests.*;
...
/**
 * Main class used to connect to Frontier server.
 */
public class Server implements Closeable {
    ...
    /**
     * FRONTIER_SUBMIT_TIMEOUT is a time in seconds after Frontier sends a timeout response
     * after internal txsub timeout.
     */
    private static final int FRONTIER_SUBMIT_TIMEOUT = 60;
    ...
    public Server(String uri) {
        this(
            ...
            new OkHttpClient.Builder()
                .addInterceptor(new ClientIdentificationInterceptor())
                .connectTimeout(10, TimeUnit.SECONDS)
                .readTimeout(FRONTIER_SUBMIT_TIMEOUT + 5, TimeUnit.SECONDS)
                .retryOnConnectionFailure(true)
                .build()
        );
     ...
     * @throws SubmitTransactionTimeoutResponseException When Frontier returns a <code>Timeout</code> or connection timeout occured.
     * @throws SubmitTransactionUnknownResponseException When unknown Frontier response is returned.
     * @throws IOException
     */
