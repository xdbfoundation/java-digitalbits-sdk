 ...
 *
 * Represents <a href="https://developers.digitalbits.io/guides/concepts/list-of-operations.html#allow-trust" target="_blank">AllowTrust</a> operation.
...
public class AllowTrustOperation extends Operation {
  ...
  public static class Builder {
    ...
    Builder(AllowTrustOp op) {
      trustor = StrKey.encodeDigitalBitsAccountId(op.getTrustor());
