...
public class KeyPair {
   ...
   * @param seed Char array containing strkey encoded DigitalBits secret seed.
   * @return {@link KeyPair}
   */
  ...
  /**
   * <strong>Insecure</strong> Creates a new DigitalBits KeyPair from a strkey encoded DigitalBits secret seed.
   ...
   * @param seed The strkey encoded DigitalBits secret seed.
   * @return {@link KeyPair}
   */
  public static KeyPair fromSecretSeed(String seed) {
    char[] charSeed = seed.toCharArray();
    byte[] decoded = StrKey.decodeDigitalBitsSecretSeed(charSeed);
    KeyPair keypair = fromSecretSeed(decoded);
   ...
   * @param accountId The strkey encoded DigitalBits account ID.
   * @return {@link KeyPair}
   */
  public static KeyPair fromAccountId(String accountId) {
    byte[] decoded = StrKey.decodeDigitalBitsAccountId(accountId);
   ...
   * @return a random DigitalBits keypair.
   */
  ...
  public String getAccountId() {
    return StrKey.encodeDigitalBitsAccountId(mPublicKey.getAbyte());
  }
  ...
  public char[] getSecretSeed() {
    return StrKey.encodeDigitalBitsSecretSeed(mPrivateKey.getSeed());
  }
