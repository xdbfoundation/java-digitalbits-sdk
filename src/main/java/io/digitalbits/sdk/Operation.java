...
public abstract class Operation {
   ...
   */
  public io.digitalbits.sdk.xdr.Operation toXdr(AccountConverter accountConverter) {
    io.digitalbits.sdk.xdr.Operation xdr = new io.digitalbits.sdk.xdr.Operation();
  ...
  public String toXdrBase64(AccountConverter accountConverter) {
    try {
      io.digitalbits.sdk.xdr.Operation operation = this.toXdr(accountConverter);
      ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
      XdrDataOutputStream xdrOutputStream = new XdrDataOutputStream(outputStream);
      io.digitalbits.sdk.xdr.Operation.encode(xdrOutputStream, operation);
   ...
   */
  public static Operation fromXdr(AccountConverter accountConverter, io.digitalbits.sdk.xdr.Operation xdr) {
    io.digitalbits.sdk.xdr.Operation.OperationBody body = xdr.getBody();
    Operation operation;
   ...
   */
  abstract io.digitalbits.sdk.xdr.Operation.OperationBody toOperationBody(AccountConverter accountConverter);
}
