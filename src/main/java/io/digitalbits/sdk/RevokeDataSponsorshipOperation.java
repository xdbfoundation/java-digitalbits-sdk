...
public class RevokeDataSponsorshipOperation extends io.digitalbits.sdk.Operation {
  ...
  public static class Builder {
    ...
    Builder(RevokeSponsorshipOp op) {
      accountId = StrKey.encodeDigitalBitsAccountId(op.getLedgerKey().getData().getAccountID());
