...
/**
 * Represents <a href="https://developers.digitalbits.io/guides/concepts/list-of-operations.html#set-options">SetOptions</a> operation.
 * @see <a href="https://developers.digitalbits.io/guides/concepts/list-of-operations.html">List of Operations</a>
 */
public class SetOptionsOperation extends Operation {
  ...
  /**
   * Indicates which flags to set. For details about the flags, please refer to the <a href="https://developers.digitalbits.io/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
   * You can also use {@link AccountFlag} enum.
   */
  ...
  io.digitalbits.sdk.xdr.Operation.OperationBody toOperationBody(AccountConverter accountConverter) {
    ...
    if (signer != null) {
      io.digitalbits.sdk.xdr.Signer signer = new io.digitalbits.sdk.xdr.Signer();
  ...
  public static class Builder {
    ...
    Builder(SetOptionsOp op) {
      if (op.getInflationDest() != null) {
        inflationDestination = StrKey.encodeDigitalBitsAccountId(op.getInflationDest());
      }
     ...
     * @param signer The signer key. Use {@link io.digitalbits.sdk.Signer} helper to create this object.
