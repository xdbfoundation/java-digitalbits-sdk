 ...
 * @see <a href="https://developers.digitalbits.io/docs/glossary/assets/" target="_blank">Assets</a>
 */
public abstract class ChangeTrustAsset implements Comparable<ChangeTrustAsset> {
   ...
   * @return    ChangeTrustAsset
   */
  public static ChangeTrustAsset fromXdr(io.digitalbits.sdk.xdr.ChangeTrustAsset xdr) {
    ...
    switch (xdr.getDiscriminant()) {
      ...
      case ASSET_TYPE_CREDIT_ALPHANUM4:
        ...
        accountId = StrKey.encodeDigitalBitsAccountId(xdr.getAlphaNum4().getIssuer());
      ...
      case ASSET_TYPE_CREDIT_ALPHANUM12:
        ...
        accountId = StrKey.encodeDigitalBitsAccountId(xdr.getAlphaNum12().getIssuer());
   ...
   * @return xdr model
   */
  public abstract io.digitalbits.sdk.xdr.ChangeTrustAsset toXdr();
  ...
  public static final class Wrapper extends ChangeTrustAsset {
    ...
    public io.digitalbits.sdk.xdr.ChangeTrustAsset toXdr() {
      ...
      io.digitalbits.sdk.xdr.Asset assetXdr = asset.toXdr();
