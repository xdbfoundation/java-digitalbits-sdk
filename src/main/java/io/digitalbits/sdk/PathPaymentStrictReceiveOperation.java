...
import io.digitalbits.sdk.xdr.PathPaymentStrictReceiveOp;
...
/**
 * Represents <a href="https://developers.digitalbits.io/guides/concepts/list-of-operations.html#path-payment-strict-receive" target="_blank">PathPaymentStrictReceive</a> operation.
 *
...
public class PathPaymentStrictReceiveOperation extends Operation {
  ...
  /**
   * The assets (other than send asset and destination asset) involved in the offers the path takes. For example, if you can only find a path from USD to EUR through XDB and BTC, the path would be USD -&raquo; XDB -&raquo; BTC -&raquo; EUR and the path would contain XDB and BTC.
   */
  ...
  io.digitalbits.sdk.xdr.Operation.OperationBody toOperationBody(AccountConverter accountConverter) {
    ...
    // path
    io.digitalbits.sdk.xdr.Asset[] path = new io.digitalbits.sdk.xdr.Asset[this.path.length];
  ...
  public static class Builder {
     ...
     *
     * @param path The assets (other than send asset and destination asset) involved in the offers the path takes. For example, if you can only find a path from USD to EUR through XDB and BTC, the path would be USD -&raquo; XDB -&raquo; BTC -&raquo; EUR and the path field would contain XDB and BTC.
