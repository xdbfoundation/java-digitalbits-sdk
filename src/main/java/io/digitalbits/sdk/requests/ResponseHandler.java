...
import io.digitalbits.sdk.responses.TypedResponse;
...
public class ResponseHandler<T> {
  ...
  public T handleResponse(final Response response) throws IOException, TooManyRequestsException {
    try {
      ...
      if (object instanceof io.digitalbits.sdk.responses.Response) {
        ((io.digitalbits.sdk.responses.Response) object).setHeaders(response.headers());
      }
