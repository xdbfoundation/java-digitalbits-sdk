...
public abstract class RequestBuilder {
   ...
   * @see <a href="https://developers.digitalbits.io/frontier/reference/resources/page.html">Page documentation</a>
   * @param cursor
   */
   ...
   * @param direction {@link io.digitalbits.sdk.requests.RequestBuilder.Order}
   */
