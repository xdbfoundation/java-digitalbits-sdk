...
import io.digitalbits.sdk.xdr.ClaimableBalanceID;
import io.digitalbits.sdk.xdr.ClaimableBalanceIDType;
...
import io.digitalbits.sdk.xdr.OperationID;
...
import io.digitalbits.sdk.xdr.TransactionV0;
import io.digitalbits.sdk.xdr.TransactionV0Envelope;
import io.digitalbits.sdk.xdr.TransactionV1Envelope;
...
/**
 * Represents <a href="https://developers.digitalbits.io/guides/concepts/transactions.html" target="_blank">Transaction</a> in DigitalBits network.
 */
public class Transaction extends AbstractTransaction {
  ...
  public String getClaimableBalanceId(int index) throws IOException {
    ...
    // https://github.com/xdbfoundation/DigitalBits/blob/9f3cc04e6ec02c38974c42545a86cdc79809252b/src/test/TestAccount.cpp#L285
    //
  ...
  private io.digitalbits.sdk.xdr.Transaction toV1Xdr(AccountConverter accountConverter) {
    ...
    io.digitalbits.sdk.xdr.Transaction v1Tx = new io.digitalbits.sdk.xdr.Transaction();
    v1Tx.setFee(fee);
  ...
  public static Transaction fromV0EnvelopeXdr(AccountConverter accountConverter, TransactionV0Envelope envelope, Network network) {
    ...
    Transaction transaction = new Transaction(
        accountConverter,
        StrKey.encodeDigitalBitsAccountId(envelope.getTx().getSourceAccountEd25519().getUint256()),
        mFee,
        mSequenceNumber,
        mOperations,
        mMemo,
   ...
   * @see io.digitalbits.sdk.TransactionBuilder
   */
