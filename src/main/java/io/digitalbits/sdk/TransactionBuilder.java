...
import io.digitalbits.sdk.TransactionPreconditions.TransactionPreconditionsBuilder;
...
import static io.digitalbits.sdk.TransactionPreconditions.TIMEOUT_INFINITE;
...
public class TransactionBuilder {
    ...
    /**
     * Adds a new <a href="https://developers.digitalbits.io/docs/start/list-of-operations/" target="_blank">operation</a> to this transaction.
     *
     * @param operation
    ...
    /**
     * Adds <a href="https://developers.digitalbits.io/docs/start/list-of-operations/" target="_blank">operation</a> to this transaction.
     *
    ...
    /**
     * Adds preconditions.
     * For details of all preconditions on transaction refer to <a href="https://github.com/xdbfoundation/digitalbits-protocol/blob/master/core/cap-0021.md#specification">CAP-21<a/>
     *
    ...
    /**
     * Adds a <a href="https://developers.digitalbits.io/docs/glossary/transactions/#memo" target="_blank">memo</a> to this transaction.
     *
     * @param memo
     * @return Builder object so you can chain methods.
     * @see Memo
    ...
    /**
     * Adds a <a href="https://developers.digitalbits.io/docs/glossary/transactions/" target="_blank">time-bounds</a> to this transaction.
     *
    ...
    public static io.digitalbits.sdk.xdr.TimeBounds buildTimeBounds(long minTime, long maxTime) {
        return new io.digitalbits.sdk.xdr.TimeBounds.Builder().minTime(new TimePoint(new Uint64(minTime)))
