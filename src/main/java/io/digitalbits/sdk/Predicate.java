...
import io.digitalbits.sdk.xdr.ClaimPredicate;
import io.digitalbits.sdk.xdr.ClaimPredicateType;
...
public abstract class Predicate {
   ...
   */
  public static Predicate fromXdr(io.digitalbits.sdk.xdr.ClaimPredicate xdr) {
   ...
   */
  public abstract io.digitalbits.sdk.xdr.ClaimPredicate toXdr();
  ...
  public static class Unconditional extends Predicate {
    ...
    public ClaimPredicate toXdr() {
      io.digitalbits.sdk.xdr.ClaimPredicate xdr = new io.digitalbits.sdk.xdr.ClaimPredicate();
