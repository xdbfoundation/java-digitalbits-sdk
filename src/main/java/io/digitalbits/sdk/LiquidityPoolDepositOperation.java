...
import io.digitalbits.sdk.xdr.LiquidityPoolDepositOp;
...
public class LiquidityPoolDepositOperation extends Operation {
    ...
    OperationBody toOperationBody(AccountConverter accountConverter) {
        ...
        op.setMaxAmountA(new io.digitalbits.sdk.xdr.Int64(Operation.toXdrAmount(this.getMaxAmountA())));
        op.setMaxAmountB(new io.digitalbits.sdk.xdr.Int64(Operation.toXdrAmount(this.getMaxAmountB())));
