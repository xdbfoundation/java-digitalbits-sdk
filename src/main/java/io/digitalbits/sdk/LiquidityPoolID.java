...
public final class LiquidityPoolID {
   ...
   */
  public static LiquidityPoolID fromXdr(io.digitalbits.sdk.xdr.PoolID xdr) {
   ...
   */
  public io.digitalbits.sdk.xdr.PoolID toXdr() {
    io.digitalbits.sdk.xdr.PoolID xdr = new io.digitalbits.sdk.xdr.PoolID();
    xdr.setPoolID(new io.digitalbits.sdk.xdr.Hash(hash));
    return xdr;
  }
}
