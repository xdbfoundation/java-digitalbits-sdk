...
public class FeeBumpTransaction extends AbstractTransaction {
  ...
  public static FeeBumpTransaction fromFeeBumpTransactionEnvelope(FeeBumpTransactionEnvelope envelope, Network network) {
    ...
    io.digitalbits.sdk.xdr.FeeBumpTransaction xdr = new io.digitalbits.sdk.xdr.FeeBumpTransaction();
    xdr.setExt(new io.digitalbits.sdk.xdr.FeeBumpTransaction.FeeBumpTransactionExt());
    ...
    io.digitalbits.sdk.xdr.FeeBumpTransaction.FeeBumpTransactionInnerTx innerXDR = new io.digitalbits.sdk.xdr.FeeBumpTransaction.FeeBumpTransactionInnerTx();
