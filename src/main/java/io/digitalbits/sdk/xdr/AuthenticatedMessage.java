...
public class AuthenticatedMessage implements XdrElement {
  ...
  public static class AuthenticatedMessageV0 {
    ...
    private DigitalBitsMessage message;
    public DigitalBitsMessage getMessage() {
      return this.message;
    }
    public void setMessage(DigitalBitsMessage value) {
      this.message = value;
    }
    ...
    public static void encode(XdrDataOutputStream stream, AuthenticatedMessageV0 encodedAuthenticatedMessageV0) throws IOException{
      ...
      DigitalBitsMessage.encode(stream, encodedAuthenticatedMessageV0.message);
    ...
    public static AuthenticatedMessageV0 decode(XdrDataInputStream stream) throws IOException {
      ...
      decodedAuthenticatedMessageV0.message = DigitalBitsMessage.decode(stream);
    ...
    public static final class Builder {
      ...
      public Builder message(DigitalBitsMessage message) {
